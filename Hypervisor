...
local commandRunning = false  -- Variable para controlar si la consola de comandos está en ejecución
...
local function main()
  ...
  term.setTextColor(colors.yellow)
  print("Press Right Ctrl to stop logging")  -- Se cambió la tecla de detención a Right Ctrl
  term.setTextColor(colors.white)
  ...
  while running do
    ...
    if key == keys.rightCtrl then  -- Se cambió la tecla de detención a Right Ctrl
